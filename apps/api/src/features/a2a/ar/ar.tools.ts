import { z } from 'zod';
import { defaultFarmCode, fluxDurationSchema, fluxTimeSchema } from '../../influxdb/influxdb.vo';
import { openWeatherQuerySchema, openWeatherUnitsSchema } from '../../openweather/openweather.vo';
